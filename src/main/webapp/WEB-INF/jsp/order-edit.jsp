...
<form action="/orders" method="post">
    <table style="border: 1px solid black;">
        ...
        <tbody>
        <tr>
            <th style="border: 1px solid black;"><input name="order_id" value="${order.orderid}" readonly></th>
            <th style="border: 1px solid black;"><input name="client_id" value="${order.client.id}" readonly></th>
